...
app.include_router(automation_router,prefix='/agent',tags=['Automation'])
app.include_router(execution_router,prefix='/agent/execution',tags=['Execution'])
app.include_router(governance_router,prefix='/agent',tags=['Governance'])
app.include_router(macro_router,prefix='/agent',tags=['Macro'])
app.include_router(market_data_router,prefix='/agent',tags=['Market Data'])
